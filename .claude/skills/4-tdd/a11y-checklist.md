...
Treat every item here as a real commitment, not a nice-to-have — this
matters most if this project's README or marketing copy claims any level
...
- [ ] Text contrast ratio minimum 4.5:1 against background (verify against
      ...
      contrast-ratio test pattern in `src/utils/contrast-ratio.ts` if this
      project has one)
